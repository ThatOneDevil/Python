...
array = np.array(["January", "Febuary", "March", "april", "may", "june", "july", "august", "september", "october", "november", "december"])
print(array)
np.append(array, "test")


#month = array(["January", "Febuary", "March", "april", "may", "june", "july", "august", "septembre", "october", "november", "december"])
#rainFall = []
